...
_frecuencia("_frecuencia", Range(0,5) ) = 0.8201058
_cantidad("_cantidad", Range(0,0.05) ) = 0
...
float4 Add1=_Time + v.vertex;
float4 Splat0=Add1.y;
float4 Multiply1=_frecuencia.xxxx * Splat0;
float4 Sin0=sin(Multiply1);
float4 Mask0=float4(0.0,Sin0.y,0.0,Sin0.w);
float4 Multiply0=_cantidad.xxxx * Mask0;
