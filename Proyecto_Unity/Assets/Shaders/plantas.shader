...
float4 Lerp4=lerp(Lerp4_0_NoInput,Multiply3,Invert0);
...
float4 Multiply5=Multiply2 * _Emission.xxxx;
float4 Add4=float4( Split0.x, Split0.x, Split0.x, Split0.x) + float4( Split0.z, Split0.z, Split0.z, Split0.z);
float4 Add5=float4( Split0.z, Split0.z, Split0.z, Split0.z) + float4( Split0.w, Split0.w, Split0.w, Split0.w);
