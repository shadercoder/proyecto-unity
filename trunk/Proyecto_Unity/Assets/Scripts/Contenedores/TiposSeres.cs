...
public class TiposSeres : MonoBehaviour {
	...
	void Awake() {
		...
		*/
		fabricaComBas = new TipoEdificio("Fábrica de componentes básicos",habsEdificios,180,20,0,0,T_elementos.comunes,10,0,0,0,0,20,0,0,modelosEdificios.fabCompBas);
