...
float4 Lerp6=lerp(Sampled2D6,Lerp6_1_NoInput,Sampled2D0);
float4 Sampled2D1=tex2D(_texLow,IN.uv_texLow.xy);
float4 Lerp2=lerp(Lerp6,Sampled2D1,Sampled2D0);
float4 Sampled2D3=tex2D(_texMedium,IN.uv_texMedium.xy);
float4 Tex2D1=tex2D(_RampaColor,Sampled2D3.xy);
float4 Sampled2D7=tex2D(_texHill,IN.uv_texHill.xy);
float4 Lerp0=lerp(Tex2D1,Sampled2D7,Sampled2D0);
float4 Lerp4=lerp(Lerp2,Lerp0,Sampled2D0);
float4 Sampled2D4=tex2D(_texMountain,IN.uv_texMountain.xy);
float4 Sampled2D5=tex2D(_texTop,IN.uv_texTop.xy);
float4 Lerp3=lerp(Sampled2D4,Sampled2D5,Sampled2D0);
float4 Lerp5=lerp(Lerp0,Lerp3,Sampled2D0);
float4 Lerp1=lerp(Lerp4,Lerp5,Sampled2D0);
